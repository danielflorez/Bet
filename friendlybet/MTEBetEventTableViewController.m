//
//  MTEBetEventTableViewController.m
//  friendlybet
//
...
@interface MTEBetEventTableViewController ()
...
@implementation MTEBetEventTableViewController
         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cellButton.frame = CGRectMake((cell.frame.size.width/2)-100,(cell.frame.size.height/2)-24,200,49);
...
- (void)eventPositionAction
{
    ...
    MTEEventPositionsTableViewController *eptvc = [storyboard instantiateViewControllerWithIdentifier:@"eventPosition"];
...
{
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Main_iPhone" bundle:nil];
    UITabBarController *tbc = [storyboard instantiateViewControllerWithIdentifier:@"tab"];
    ...
    MTEGroupViewController *gvc = [tbc.viewControllers objectAtIndex:0];
    MTEGroupMatchesTableViewController *roundSixteen = [tbc.viewControllers objectAtIndex:1];
    MTEGroupMatchesTableViewController *roundEight = [tbc.viewControllers objectAtIndex:2];
    MTEGroupMatchesTableViewController *semiFinal = [tbc.viewControllers objectAtIndex:3];
    MTEGroupMatchesTableViewController *final = [tbc.viewControllers objectAtIndex:4];
    gvc.event = self.event;
