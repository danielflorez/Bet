...
@interface MTEInviteViewController ()
...
@property (weak, nonatomic) IBOutlet UITextView *emailLaber;
...
@implementation MTEInviteViewController
...
- (void)viewDidLoad
{
    ...
    self.emailTextField.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"Invite_mail_field.png"]];
    self.emailTextField.textColor = [UIColor whiteColor];
    self.emailLaber.text = title;
    self.emailLaber.textColor = [UIColor whiteColor];
...
- (IBAction)inviteClick:(id)sender {
    NSArray *e = [self.emailTextField.text componentsSeparatedByString:@","];
