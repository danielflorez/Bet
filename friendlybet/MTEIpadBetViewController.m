...
@interface MTEIpadBetViewController ()
@property (nonatomic, strong) NSMutableData *dataRecieved;
@property (nonatomic, strong) UIActivityIndicatorView *spinner;
@property (weak, nonatomic) IBOutlet UIButton *saveButton;
@property (weak, nonatomic) IBOutlet UIButton *cancelButton;
@property (weak, nonatomic) IBOutlet UIButton *seeBetsButton;

@end

@implementation MTEIpadBetViewController
...
- (void)viewDidLoad
{
    ...
    [self.seeBetsButton setTitle:seeButton forState:UIControlStateNormal];
    [self.seeBetsButton setBackgroundImage:[UIImage imageNamed:@"Background_buttons.png"]
                              forState:UIControlStateNormal];
