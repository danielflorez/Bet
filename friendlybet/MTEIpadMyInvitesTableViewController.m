//
//  MTEIpadMyInvitesTableViewController.m
//  friendlybet
//
...
@interface MTEIpadMyInvitesTableViewController ()
@property (nonatomic, strong) UIActivityIndicatorView *spinner;
@property (nonatomic, strong) NSMutableData *dataRecieved;
@end

@implementation MTEIpadMyInvitesTableViewController
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ipadInvite"
                                                            forIndexPath:indexPath];
    cell.backgroundColor = [UIColor clearColor];
    UILabel *lblName = (UILabel *)[cell viewWithTag:100];
    lblName.font = [UIFont systemFontOfSize:22];
                 ...
                 sender:(id)sender
{
    ...
    MTEIpadAcceptInvitesViewController *aivc = [segue destinationViewController];
