//
//  MTEIpadMembersBetTableViewController.m
//  friendlybet
//
...
@interface MTEIpadMembersBetTableViewController ()
@property (nonatomic, strong) UIActivityIndicatorView *spinner;
@property (nonatomic, strong) NSMutableData *dataRecieved;

@end

@implementation MTEIpadMembersBetTableViewController
         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UILabel *name = [[UILabel alloc] initWithFrame:CGRectMake(10, (cell.frame.size.height)-30, 200, 30)];
    UILabel *score1 = [[UILabel alloc] initWithFrame:CGRectMake(cell.frame.size.width - 350, (cell.frame.size.height)-30, 150, 30)];
    UILabel *score2 = [[UILabel alloc] initWithFrame:CGRectMake(cell.frame.size.width - 200, (cell.frame.size.height)-30, 150, 30)];
    ...
    [score1 setFont:[UIFont systemFontOfSize:22]];
    [score2 setFont:[UIFont systemFontOfSize:22]];
...
viewForHeaderInSection:(NSInteger)section {
    ...
    UILabel *name = [[UILabel alloc] initWithFrame:CGRectMake(10, (cell.frame.size.height)-30, 100, 30)];
    UILabel *team1 = [[UILabel alloc] initWithFrame:CGRectMake(cell.frame.size.width - 350, (cell.frame.size.height)-30, 150, 30)];
    UILabel *team2 = [[UILabel alloc] initWithFrame:CGRectMake(cell.frame.size.width - 200, (cell.frame.size.height)-30, 150, 30)];
    NSString *language = [[NSLocale preferredLanguages] objectAtIndex:0];
    NSString *nameT;
    if([language isEqualToString:@"en"])
    {
    ...
    [name setFont:[UIFont systemFontOfSize:22]];
    [team1 setFont:[UIFont systemFontOfSize:22]];
    [team2 setFont:[UIFont systemFontOfSize:22]];
