//
//  MTEIpadEventPositionsTableViewController.m
//  friendlybet
//
...
@interface MTEIpadEventPositionsTableViewController ()
@property (nonatomic, strong) UIActivityIndicatorView *spinner;
@property (nonatomic, strong) NSMutableData *dataRecieved;
@end

@implementation MTEIpadEventPositionsTableViewController
...
- (void)viewDidLoad
{
    ...
    //self.bannerView_.frame = CGRectMake(0, self.view.frame.size.height - 160, self.view.frame.size.width, 90);
         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UILabel *nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(44, (cell.frame.size.height/2)-19, 200, 38)];
    nameLabel.text = m.name;
    UILabel *pointsLabel = [[UILabel alloc] initWithFrame:CGRectMake(cell.frame.size.width - 192, (cell.frame.size.height/2)-12, 72, 24)];
    pointsLabel.text =  m.pointsActualEvent;
    [pointsLabel setTextAlignment:NSTextAlignmentCenter];
    
    UILabel *prizeLabel = [[UILabel alloc] initWithFrame:CGRectMake(cell.frame.size.width - 120, (cell.frame.size.height/2)-12, 120, 24)];
    ...
    [pointsLabel setFont:[UIFont systemFontOfSize:22]];
    [nameLabel setFont:[UIFont systemFontOfSize:22]];
    [posButton setFont:[UIFont systemFontOfSize:22]];
    [prizeLabel setFont:[UIFont systemFontOfSize:22]];
...
viewForHeaderInSection:(NSInteger)section {
    UITableViewCell *cell = [[UITableViewCell alloc] init];
    cell.frame = CGRectMake(0, 0,self.tableView.frame.size.width, 130);
    [cell addSubview:self.bannerView_];
    UILabel *pos = [[UILabel alloc] initWithFrame:CGRectMake(2, (cell.frame.size.height)-30, 40, 30)];
    UILabel *name = [[UILabel alloc] initWithFrame:CGRectMake(44, (cell.frame.size.height)-30, 150, 30)];
    UILabel *points = [[UILabel alloc] initWithFrame:CGRectMake(cell.frame.size.width - 192, (cell.frame.size.height)-30, 72, 30)];
    UILabel *prize = [[UILabel alloc] initWithFrame:CGRectMake(cell.frame.size.width - 120, (cell.frame.size.height)-30, 120, 30)];
    NSString *language = [[NSLocale preferredLanguages] objectAtIndex:0];
    NSString *nameT;
    NSString *pointsT;
    NSString *prizet;
    ...
    cell.backgroundColor = [UIColor clearColor];
    [pos setFont:[UIFont systemFontOfSize:22]];
    [name setFont:[UIFont systemFontOfSize:22]];
    [points setFont:[UIFont systemFontOfSize:22]];
    [prize setFont:[UIFont systemFontOfSize:22]];
