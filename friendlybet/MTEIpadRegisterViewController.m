...
#import "MTEIpadTermsViewController.h"
...
@property (nonatomic, strong) MTEIpadTermsViewController *terms;
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    ...
    if([dat isEqualToString:@"OK"])
    {
        ...
        if([language isEqualToString:@"en"])
        {
            ...
            title = @"Para terminar el proceso de registro siga las instrucciones en el email de activacion que se le acaba de enviar.";
        }
...
- (IBAction)termsAction:(id)sender
{
    if (!self.terms)
    {
        self.terms = [[MTEIpadTermsViewController alloc]init];
    }
    self.terms.rvc = self;
