//
//  MTEAcceptInvitesViewController.m
//  friendlybet
//
...
@interface MTEAcceptInvitesViewController ()
...
@implementation MTEAcceptInvitesViewController
...
- (void)viewDidLoad
{
    ...
    UIView *topView = [[UIView alloc] initWithFrame:CGRectMake(0, 49, self.view.frame.size.width, self.view.frame.size.height/6)];
    topView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"Invite_Mail_field.png"]];
    UILabel *eventTLabel = [[UILabel alloc] initWithFrame:CGRectMake((topView.frame.size.width/2)-40, 20, 80, 30)];
    ...
    UIImageView *ball1 = [[UIImageView alloc] initWithFrame:CGRectMake((topView.frame.size.width/2)-80, 25, 20, 20)];
    ball1.image = [UIImage imageNamed:@"Invite_ball.png"];
    UIImageView *ball2 = [[UIImageView alloc] initWithFrame:CGRectMake((topView.frame.size.width/2)+62, 25, 20, 20)];
    ball2.image = [UIImage imageNamed:@"Invite_ball.png"];
    UILabel *evName = [[UILabel alloc] initWithFrame:CGRectMake((topView.frame.size.width/2)-100, 50, 200, 30)];
    ...
    middleView.frame = CGRectMake(0, (self.view.frame.size.height/6)+49, self.view.frame.size.width, (self.view.frame.size.height/4)-46);
    middleView.backgroundColor = [UIColor clearColor];
    UIImageView *userIm = [[UIImageView alloc] initWithFrame:CGRectMake((middleView.frame.size.width/2)-10, 4, 20, 20)];
    userIm.image = [UIImage imageNamed:@"User_icon_2.png"];
    UILabel *eventOwner = [[UILabel alloc] initWithFrame:CGRectMake((middleView.frame.size.width/2)-100, 18, 200, 30)];
    ...
    UIImageView *emailIm = [[UIImageView alloc] initWithFrame:CGRectMake((middleView.frame.size.width/2)-10, 48, 20, 20)];
    emailIm.image = [UIImage imageNamed:@"Mail_icon_2.png"];
    UILabel *email = [[UILabel alloc] initWithFrame:CGRectMake((middleView.frame.size.width/2)-100, 66, 200, 30)];
    ...
    self.acceptButton.frame =  CGRectMake((bottomView.frame.size.width/2)-100, 20, 200, 28);
    ...
    self.rejectButton = [[UIButton alloc] initWithFrame:CGRectMake((bottomView.frame.size.width/2)-100, 55, 200, 28)];
