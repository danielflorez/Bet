//
//  MTEIpadEventsTableViewController.m
//  friendlybet
//
...
@interface MTEIpadEventsTableViewController ()
...
@implementation MTEIpadEventsTableViewController
         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.frame = CGRectMake(50, 0, self.tableView.frame.size.width, 44);
    UILabel *lblName = [[UILabel alloc] initWithFrame:CGRectMake(60,(cell.frame.size.height/2)-16, 400, 32)];
    [lblName setText:[ev name]];
    [lblName setTextColor:[UIColor whiteColor]];
    [lblName setFont:[UIFont systemFontOfSize:22]];
    [cell addSubview:lblName];
    cell.backgroundColor = [UIColor clearColor];
    if (self.bevc.facebookLogin)
    {
        UIButton *fbshareButton = [[UIButton alloc] init];
        fbshareButton.frame = CGRectMake(628, (cell.frame.size.height/2)-16, 69, 32);
        [fbshareButton setBackgroundImage:[UIImage imageNamed:@"fbshare.png"] forState:UIControlStateNormal];
        [fbshareButton addTarget:self action:@selector(fbShareAction:) forControlEvents:UIControlEventTouchUpInside];
        [cell addSubview:fbshareButton];
    }
    UIImage *bgI = [UIImage imageNamed:@"List_Field_Ipad.png"];
    ...
    if (indexPath.row == [self.events count]-1) {
        ...
        separatorLineView1.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"List_Field_line_Ipad.png"]];
...
viewForFooterInSection:(NSInteger)section
{
    ...
    if ([self.events count] == 0) {
        UITextView *te = [[UITextView alloc] init];
        te.frame = CGRectMake(0, 0, cell.frame.size.width, cell.frame.size.height);
        NSString *textLabel;
        ...
        te.text = textLabel;
        te.font = [UIFont systemFontOfSize:22];
