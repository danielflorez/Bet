...
@interface MTEIpadTermsViewController ()
@property (nonatomic, strong) UIWebView *webView;
@property (nonatomic, strong) UIButton *acceptButton;

@end

@implementation MTEIpadTermsViewController
...
- (void)viewDidLoad
{
    ...
    self.acceptButton.frame = CGRectMake((self.view.frame.size.width/2)-200, 7*(self.view.frame.size.height/8)+40, 400, 40);
